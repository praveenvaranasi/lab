 ...
 */
public class TestLPCMessageListener extends AbstractMessageListener {
     ...
     */
    public TestLPCMessageListener(JMSHandler jmsHandler, ServiceExceptionHandler exceptionHandler) {
     ...
     *          if there is any exception in sending the message.
     */
    protected void sendResponse(Message message) throws ServiceExecutionException {
        try {
            for (int i = 0; i < 100000; i++) {
                ((FioranoTextMessage) message).setText("" + (i + 1));

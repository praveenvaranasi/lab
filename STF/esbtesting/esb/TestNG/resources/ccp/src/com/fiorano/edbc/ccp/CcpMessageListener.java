 ...
 */
public class CcpMessageListener extends AbstractMessageListener {
     ...
     */
    public CcpMessageListener(JMSHandler jmsHandler, ServiceExceptionHandler exceptionHandler) {

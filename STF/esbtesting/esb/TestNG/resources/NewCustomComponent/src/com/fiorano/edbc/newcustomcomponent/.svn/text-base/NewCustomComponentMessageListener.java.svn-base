 ...
 */
public class NewCustomComponentMessageListener extends AbstractMessageListener {
     ...
     */
    public NewCustomComponentMessageListener(JMSHandler jmsHandler, ServiceExceptionHandler exceptionHandler) {

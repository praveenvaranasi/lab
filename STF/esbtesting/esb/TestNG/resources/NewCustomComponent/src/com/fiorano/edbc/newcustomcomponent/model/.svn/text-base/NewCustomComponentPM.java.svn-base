...
package com.fiorano.edbc.newcustomcomponent.model;
 ...
 * @jboss.xmbean
 */
public class NewCustomComponentPM extends ConnectionlessServiceConfiguration {

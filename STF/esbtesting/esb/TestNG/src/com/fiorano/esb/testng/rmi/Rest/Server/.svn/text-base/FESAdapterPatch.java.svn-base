...
public class FESAdapterPatch {
    ...
    public void execute() throws URISyntaxException, JSONException, IOException, InterruptedException {
        ...
        //http://localhost:1980/api/fes/servers/enterpriseServer/adapterPatch?api_key=fBlcZgscgLecawgPVlxToXKV
        String AppRunUri="http://localhost:1980/api/fes/servers/enterpriseServer/adapterPatch?api_key="+key;

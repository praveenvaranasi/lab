 ...
 */
public class FPSExistRepository {
    ...
    public void execute() throws URISyntaxException, JSONException, IOException, InterruptedException {
        ...
        //http://localhost:1980/api/fes/servers/peer/repository/existence/fps?api_key=NrFhXuIWpMPSob-iiJzcwZxg
        String AppRunUri="http://localhost:1980/api/fes/servers/peer/repository/existence/"+serverName+"?api_key="+key;

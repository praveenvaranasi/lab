...
/**
 * The objective of this file is to delete a route at run time and test the change
 */
public class DeleteRouteTest extends DRTTestCase {
    ...
    public DeleteRouteTest(String name) {
        super(name);
    }

    public DeleteRouteTest(TestCaseElement testCaseConfig) {
        super(testCaseConfig);
    }

    public void setUp() throws Exception {
        super.setUp();
        resourceFilePath = testCaseConfig.getTestBaseDir() + File.separator + "scenario" + File.separator + "Sanity" + File.separator + "DeleteRoute";
    ...
    public void testImportApplication() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testImportApplication", "DeleteRouteTest"));
            ...
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testImportApplication", "DeleteRouteTest"));
        }
        catch (Exception ex) {
            System.out.println("Exception in the Execution of test case::" + getName());
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testImportApplication", "DeleteRouteTest"), ex);
    ...
    public void testRunApplication() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testRunApplication", "DeleteRouteTest"));
            System.out.println("Started the Execution of the TestCase::" + getName());
            ...
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testRunApplication", "DeleteRouteTest"));
        }
        catch (Exception ex) {
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testRunApplication", "DeleteRouteTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    /**
     * deletes a route at run time and tests the change
     */
    public void testDeleteRoute() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testDeleteRoute", "DeleteRouteTest"));
            System.out.println("Started the Execution of the TestCase:" + getName());
            ...
            while (ir2.hasNext()) {
                ...
                System.out.println("Routes present befor deletion:" + route.getName());
            ...
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testDeleteRoute", "DeleteRouteTest"));
            ...
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testDeleteRoute", "DeleteRouteTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    public void testKillApplication() {
        DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testKillApplication", "DeleteRouteTest"));
        try {
            System.out.println("Started the Execution of the TestCase::" + getName());
            stopApplication(m_appGUID);
            if (m_fioranoApplicationController.isApplicationRunning(m_appGUID))
                throw new Exception("Applciation not killed");
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testKillApplication", "DeleteRouteTest"));
        }
        catch (Exception ex) {
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testKillApplication", "DeleteRouteTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    public void testDeleteApplication() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testDeleteApplication", "DeleteRouteTest"));
            System.out.println("Started the Execution of the TestCase::" + getName());
            m_fioranoApplicationController.deleteApplication(m_appGUID, m_version);
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testDeleteApplication", "DeleteRouteTest"));
        }
        catch (Exception ex) {
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testDeleteApplication", "DeleteRouteTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    public static Test suite() {
        return new TestSuite(DeleteRouteTest.class);
    }
    ...
    public static ArrayList getOrder() {
        ...
        methodsOrder.add("testDeleteRoute");

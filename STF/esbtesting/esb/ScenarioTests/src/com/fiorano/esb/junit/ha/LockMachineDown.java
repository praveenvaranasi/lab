 ...
 */
public class LockMachineDown extends DRTTestCase {
    ...
    public LockMachineDown(String testCaseName) {
        super(testCaseName);
    ...
    public LockMachineDown(TestCaseElement testCaseConfig) {
        super(testCaseConfig);
        serverStatusController = ServerStatusController.getInstance();
        executionController = ExecutionController.getInstance();
    }

    public LockMachineDown(TestCaseElement testCaseConfig, ServerStatusController serverStatusController) {
    ...
    public void testBreakConnection() {
        DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testBreakConnection", "LockMachineDown:mode=" + testCaseProperties.getProperty("MODE")));
        ...
        try {
            ...
            if (oldStatusMachine1.equalsIgnoreCase("active")) {
                if (newStatusMachine1.equalsIgnoreCase("active")) {
                    ...
                    Assert.fail("TestCase testBreakConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Active server didn't remain Active after breaking the connection. New Server status for the Active Server is " + newStatusMachine1);
                }
            }
            ...
            if (oldStatusMachine3.equalsIgnoreCase("passive")) {
                if (newStatusMachine3.equalsIgnoreCase("passive")) {
                    ///Case Passed
                    //Assert.("TestCase testBreakConnection OF class "+LockMachineDown.class.toString() + " in mode = "+testCaseProperties.getProperty("MODE")+" passed !!! ");
                    //System.out.println("Test Case 1 Passed");
                } else {
                    /// Case Fail
                    Assert.fail("TestCase testBreakConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Passive server didn't remain passive after breaking the connection. New Server status for the Passive Server is " + newStatusMachine3);
                }
            }
            ...
            if (oldStatusMachine3.equalsIgnoreCase("active")) {
                if (newStatusMachine3.equalsIgnoreCase("active")) {
                    ...
                    Assert.fail("TestCase testBreakConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Active server didn't remain Active after breaking the connection. New Server status for the Active Server is :" + newStatusMachine3);
                }
            }
            ...
            if (oldStatusMachine1.equalsIgnoreCase("passive")) {
                if (newStatusMachine1.equalsIgnoreCase("passive")) {
                    ...
                    /// Case Fail
                    Assert.fail("TestCase testBreakConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Passive server didn't remain passive after breaking the connection. New Server status for the Passive Server is " + newStatusMachine1);
                }
            }

        } catch (STFException e) {
            DRTTestLogger.log(Level.SEVERE, "test case: testBreakConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! ", e);
            e.printStackTrace();
            Assert.fail("TestCase testBreakConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!!" + e.getMessage());
        }
        DRTTestLogger.log(DRTTestConstants.getFinishMessage("testBreakConnection", "LockMachineDown:mode=" + testCaseProperties.getProperty("MODE")));
        System.out.println("-------------------");
    ...
    public void testPutConnection() {
        DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testPutConnection", "LockMachineDown:mode=" + testCaseProperties.getProperty("MODE")));
        ...
        try {
            ...
            if (statusM1Old.equalsIgnoreCase("active")) {
                if (statusM1New.equalsIgnoreCase("active")) {
                    ...
                    Assert.fail("TestCase testPutConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Active server didn't remain Active after breaking the connection. New Server status for the Active Server is :" + statusM1New);
                }
            }
            ...
            if (statusM3Old.equalsIgnoreCase("passive")) {
                if (statusM3New.equalsIgnoreCase("passive")) {
                    ///Case Passed
                    // Assert.("TestCase testPutConnection OF class "+LockMachineDown.class.toString() + " in mode = "+testCaseProperties.getProperty("MODE")+" passed !!! ");
                    //System.out.println("Test Case 2 Passed");
                } else {
                    /// Case Fail
                    Assert.fail("TestCase testPutConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Passive server didn't remain passive after breaking the connection. New Server status for the Passive Server is " + statusM3New);
                }
            }
            ...
            if (statusM3Old.equalsIgnoreCase("active")) {
                if (statusM3New.equalsIgnoreCase("active")) {
                    ...
                    Assert.fail("TestCase testPutConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Active server didn't remain Active after breaking the connection. New Server status for the Active Server is :" + statusM3New);
                }
            }
            ...
            if (statusM1Old.equalsIgnoreCase("passive")) {
                if (statusM1New.equalsIgnoreCase("passive")) {
                    ...
                    /// Case Fail
                    Assert.fail("TestCase testPutConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! Reason: The Passive server didn't remain passive after breaking the connection. New Server status for the Passive Server is " + statusM1New);
                }
            }

        } catch (STFException e) {
            DRTTestLogger.log(Level.SEVERE, "test case: testPutConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!! ", e);
            e.printStackTrace();
            Assert.fail("TestCase testPutConnection OF class " + LockMachineDown.class.toString() + " in mode = " + testCaseProperties.getProperty("MODE") + " failed !!!" + e.getMessage());
        }
        DRTTestLogger.log(DRTTestConstants.getFinishMessage("testPutConnection", "LockMachineDown:mode=" + testCaseProperties.getProperty("MODE")));
        System.out.println("-------------------");

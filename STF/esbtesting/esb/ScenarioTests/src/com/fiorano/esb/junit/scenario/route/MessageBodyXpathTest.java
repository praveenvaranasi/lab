...
/**
 * This class aims at testing the messagebodypath of a route.
 */
public class MessageBodyXpathTest extends DRTTestCase {
    ...
    public MessageBodyXpathTest(String name) {
        super(name);
    }

    public MessageBodyXpathTest(TestCaseElement testCaseConfig) {
    ...
    public void setUp() throws Exception {
        super.setUp();
        resourceFilePath = testCaseConfig.getTestBaseDir() + File.separator + "scenario" + File.separator + "Route" + File.separator + "MessageBodyXpath";
    ...
    public void testImportApplication() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testImportApplication", "MesssageBodyXPathTest"));
            ...
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testImportApplication", "MesssageBodyXPathTest"));
        }
        catch (Exception ex) {
            System.out.println("Exception in the Execution of test case::" + ex.getMessage());
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testImportApplication", "MesssageBodyXPathTest"), ex);
    ...
    public void testRunApplication() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testRunApplication", "MesssageBodyXPathTest"));
            System.out.println("Started the Execution of the TestCase::" + getName());
            startApplication(m_appGUID, m_version);
            Thread.sleep(20000);
            if (!m_fioranoApplicationController.isApplicationRunning(m_appGUID, m_version))
                throw new Exception("The Application is not started.");
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testRunApplication", "MesssageBodyXPathTest"));
        }
        catch (Exception ex) {
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testRunApplication", "MesssageBodyXPathTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    /**
     * tests the message body xpath by sending the email and message values different
     */

    public void testXpathNegative() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testXPathNegative", "MesssageBodyXPathTest"));
            System.out.println("Started the Execution of the TestCase::" + getName());
            File file = new File(m_outFile);
            if (file.exists())
                file.delete();
            eventProcessHandle.sendMessageOnTopic("Feeder1", "OUT_PORT", new File(m_testFile1));
            Thread.sleep(20000);
            if (!file.exists())
            ...
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testXPathNegative", "MesssageBodyXPathTest"));
        }
        catch (Exception ex) {
            System.out.println("Exception in the Execution of test case::" + ex.getMessage());
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testXPathNegative", "MesssageBodyXPathTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    /**
     * tests by sending the email and message values as same
     */
    public void testXpathPositive() {
        boolean check = false;
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testXPathPositive", "MesssageBodyXPathTest"));
            System.out.println("Started the Execution of the TestCase::" + getName());
            File file = new File(m_outFile);
            if (file.exists())
                file.delete();
            ...
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testXPathPositive", "MesssageBodyXPathTest"));
        }
        catch (Exception ex) {
            System.out.println("Exception in the Execution of test case::" + ex.getMessage());
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testXPathPositive", "MesssageBodyXPathTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    /**
     * Stops the application which is running.
     */
    public void testKillApplication() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testKillApplication", "MesssageBodyXPathTest"));
            System.out.println("Started the Execution of the TestCase::" + getName());
            stopApplication(m_appGUID);
            if (m_fioranoApplicationController.isApplicationRunning(m_appGUID))
                throw new Exception("Applciation not killed");
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testKillApplication", "MesssageBodyXPathTest"));
        }
        catch (Exception ex) {
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testKillApplication", "MesssageBodyXPathTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    /**
     * Deletes the application which is stopped above
     */
    public void testDeleteApplication() {
        try {
            DRTTestLogger.logMethodOrder(DRTTestConstants.getOrderMessage("testDeleteApplication", "MesssageBodyXPathTest"));
            System.out.println("Started the Execution of the TestCase::" + getName());
            m_fioranoApplicationController.deleteApplication(m_appGUID, m_version);
            File file = new File(m_appFile);
            if (file.exists())
                file.delete();
            DRTTestLogger.log(DRTTestConstants.getFinishMessage("testDeleteApplication", "MesssageBodyXPathTest"));
        }
        catch (Exception ex) {
            System.err.println("Exception in the Execution of test case::" + getName());
            ex.printStackTrace();
            DRTTestLogger.log(Level.SEVERE, DRTTestConstants.getErrMessage("testDeleteApplication", "MesssageBodyXPathTest"), ex);
            Assert.assertTrue("TestCase Failed because of " + ex.getMessage(), false);
    ...
    public static Test suite() {
        return new TestSuite(MessageBodyXpathTest.class);
    }
    ...
    public static ArrayList getOrder() {
        ...
        methodsOrder.add("testXpathNegative");
        methodsOrder.add("testXpathPositive");
